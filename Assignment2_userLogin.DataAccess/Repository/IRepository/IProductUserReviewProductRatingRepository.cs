...
{
    public interface IProductUserReviewProductRatingRepository:IRepository<ProductUserReviewProductRating>
    {
        IEnumerable<ProductUserReviewProductRating> ProductFullDetails();
